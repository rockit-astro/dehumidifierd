Name:      superwasp-dehumidifier-server
Version:   20221122
Release:   0
Url:       https://github.com/warwick-one-metre/dehumidifierd
Summary:   Dehumidifier server for the SuperWASP telescope.
License:   GPL-3.0
Group:     Unspecified
BuildArch: noarch
...
%{__install} %{_sourcedir}/superwasp.json %{buildroot}%{_sysconfdir}/dehumidifierd/
